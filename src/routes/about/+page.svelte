...
<div class="bg-gradient-to-br from-orange-200 via-rose-300 to-yellow-200 h-full">
    ...
    <div class="w-10 text-center md:ml-48 ml-10 mt-24 font-semibold slideRight">Info</div>
    ...
    <div class="flex flex-col md:flex-row p-2 mt-24 md:ml-28">
        <div class="flex justify-center">
    ...
    <div class="flex flex-col md:flex-row justify-center p-2 mt-10 pb-10 md:ml-48 lg:ml-60 lg:w-fit">
        ...
        <h1 class="lg:max-w-md text-2xl h-56 font-bold mt-3 backdrop-blur-lg bg-white/60 drop-shadow-xl shadow-xl p-5 rounded-lg slideRight">
            ...
            <div class="flex mt-2">
                ...
                <a href="https://drive.google.com/file/d/1PFInKluGJVMn6KbqJ1Qwok0wJrT0A6fj/view?usp=sharing" target="_blank" class="text-base font-semibold ml-2 hover:text-red-500">Click here to view my resume</a>
            </div>
        </h1>
        </div>
        <div class="flex justify-center">
